...
export function Servicios() {
  ...
  const listaServicios = [
    { id: 1, titulo: "Búsqueda Inversa de Talento", descripcion: "Busca proactivamente perfiles locales idóneos en una base de datos transparente y sin sesgos.", imagen: "https://images.unsplash.com/photo-1521737711867-e3b904737572?w=500" },
